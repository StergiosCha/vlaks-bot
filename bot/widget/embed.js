...
(function () {
  ...
  (function () {
  const API=(window.VLAX_API||'');
  // Όταν το widget τρέχει μέσα στο site (άλλο origin), τα avatars ζουν στον bot server,
  // όχι στο site. Χωρίς αυτό, το /avatar δείχνει στο GitHub Pages και βγάζει 404.
  const AV=(window.VLAX_AVATARS||(API?API+'/avatar':'/avatar'));
